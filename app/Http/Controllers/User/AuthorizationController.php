...
class AuthorizationController extends Controller
{
    function authorizeForm() {
        ...
        $authorizeEmailContent   = getSiteData('email_confirm.content', true);
        $authorizeSmsContent     = getSiteData('mobile_confirm.content', true);
        $authorizeUserBanContent = getSiteData('user_ban.content', true);
        $authorize2faContent     = getSiteData('2fa_confirm.content', true);
        ...
        return view($this->activeTheme. 'user.auth.authorization.'.$type, compact('user', 'pageTitle', 'authorizeEmailContent', 'authorizeSmsContent', 'authorizeUserBanContent', 'authorize2faContent'));
    }
