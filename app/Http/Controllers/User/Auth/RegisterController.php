...
class RegisterController extends Controller
{
    ...
    function registerForm() {
        ...
        $registerContent = SiteData::where('data_key', 'register.content')->firstOrFail();

        return view($this->activeTheme . 'user.auth.register', compact('pageTitle', 'mobileCode', 'countries', 'registerContent'));
    }
