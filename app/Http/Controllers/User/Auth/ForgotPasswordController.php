...
class ForgotPasswordController extends Controller
{
    function requestForm() {
        ...
        $forgotPasswordContent = SiteData::where('data_key', 'forgot_password.content')->firstOrFail();
    ...
    function verificationForm() {
        ...
        $codeVerificationContent = SiteData::where('data_key', 'code_verification.content')->firstOrFail();
        ...
        return view($this->activeTheme . 'user.auth.password.codeVerification', compact('pageTitle', 'email', 'codeVerificationContent'));
    }
